...
public class ParticleShader extends ShaderProgram {
	...
	private int location_texCoords1;
	private int location_texCoords2;
	...
	protected void getAllUniformLocations() {
		...
		location_texCoords1 = super.getUniformLocation("texOffset1");
		location_texCoords2 = super.getUniformLocation("texOffset2");
	...
	protected void loadTextureCoordInfo(Vector2f offset1,Vector2f offset2,float numRows , float blend){
		super.load2DVector(location_texCoords1, offset1);
		super.load2DVector(location_texCoords2, offset2);
